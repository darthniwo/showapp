...
(function (angular) {
  angular.module('sbx').factory('infoSrv', ['$cookies', 'alertify', 'commonSrv', '$filter', infoSrv]);
  ...
  function infoSrv($cookies, alertify, commonSrv, $filter) {
    ...
    info.get = function (onSuccess, onError) {
      ...
      let query = common.queryBuilder().setDomain(common.actual_domain).setModel('informacion').compile();
    ...
    */
    info.getRegister = function (key, onSuccess, onError) {
      ...
      let query = common.queryBuilder().setDomain(common.actual_domain).setModel('informacion').whereWithKeys([key]).compile();
    ...
    */
    ...
    info.set = function (data_object, onSuccess, onError) {
      ...
      let query = common.queryBuilder().setDomain(common.actual_domain).setModel('informacion').addObject(data_object).compile();
...
//# sourceMappingURL=infoSrv.js.map
